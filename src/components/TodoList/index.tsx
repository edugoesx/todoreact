      ...
      <div className={` ${themeConfig[theme].todo.backgroundColor} rounded-md"`}>
        <ul>
                ...
                <div className="flex items-center gap-4">
                  <span className="w-6 h-6 rounded-full hover:bg-[linear-gradient(to_right,hsl(192,100%,67%),hsl(280,87%,65%))]  hover:p-[1px]">
                    <button
                      ...
                      {todo.completed && (<img src={IconCheck} alt="check" className="h-2 w-2 m-auto" />)}
                    </button>
                  </span>
          ...
          <div className={`text-sm flex justify-between p-4 ${themeConfig[theme].layout.textColor}`}>
            ...
            <button className={`${theme === "dark" ? "hover:text-neutral-light-grayish-blue-hover" : "hover:text-neutral-very-dark-grayish-blue"}`}>Clear Completed</button>
          </div>
